...
import com.aeneas.generator.GeneratorSettings.NodeAddress
import com.aeneas.generator.Preconditions.{PGenSettings, UniverseHolder}
import com.aeneas.generator.cli.ScoptImplicits
import com.aeneas.generator.config.FicusImplicits
import com.aeneas.generator.utils.Universe
import com.aeneas.network.client.NetworkSender
...
import com.aeneas.utils.{LoggerFacade, NTP}
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  // IDEA bugs
  implicit val inetSocketAddressReader: ValueReader[InetSocketAddress] = com.aeneas.settings.inetSocketAddressReader
  ...
  val parser = new OptionParser[GeneratorSettings]("generator") {
    head("TransactionsGenerator - Aeneas load testing transactions generator")
