...
import com.aeneas.it.sync.smartcontract.setScrTxSupportedVersions
...
import com.wavesplatform.protobuf.transaction.{Recipient, SetScriptTransactionData, SignedTransaction, TransferTransactionData, Transaction => PBTransaction}
