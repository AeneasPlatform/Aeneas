...
import com.aeneas.it.api.BurnTransactionInfo
import com.aeneas.it.api.SyncHttpApi._
import com.aeneas.it.sync.{issueAmount, issueFee, _}
...
class BurnTransactionSuite extends BaseTransactionSuite {
  ...
  test("burning assets changes issuer's asset balance; issuer's ash balance is decreased by fee") {
