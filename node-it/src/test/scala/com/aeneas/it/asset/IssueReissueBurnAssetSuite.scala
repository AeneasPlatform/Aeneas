...
import com.aeneas.api.http.ApiError.{CustomValidationError, TransactionDoesNotExist}
import com.aeneas.common.state.ByteStr
import com.aeneas.common.utils.{Base58, EitherExt2}
import com.aeneas.it.BaseSuite
import com.aeneas.it.api.SyncHttpApi._
import com.aeneas.it.api.{AssetInfo, BurnInfoResponse, IssueInfoResponse, ReissueInfoResponse, StateChangesDetails, Transaction}
import com.aeneas.it.sync._
import com.aeneas.it.util._
import com.aeneas.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_BYTESTR, CONST_LONG}
...
class IssueReissueBurnAssetSuite extends BaseSuite {
  override val nodeConfigs: Seq[Config] =
    com.aeneas.it.NodeConfigs.newBuilder
