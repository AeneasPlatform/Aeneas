...
import com.aeneas.protobuf.transaction.{PBSignedTransaction, PBTransaction, PBTransactions, VanillaTransaction}
...
object SyncGrpcApi extends Assertions {
  ...
  implicit class NodeExtGrpc(n: Node) {
    ...
    import com.aeneas.account.{Address => Addr}
    import com.aeneas.it.api.AsyncGrpcApi.{NodeAsyncGrpcApi => async}
    ...
    def stateChanges(request: TransactionsRequest): Seq[(com.aeneas.transaction.Transaction, StateChangesDetails)] = {
