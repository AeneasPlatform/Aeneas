...
import com.aeneas.transaction.{GenesisTransaction, LegacyPBSwitch, PaymentTransaction, Transaction, TransactionParsers, TxValidationError}
import com.aeneas.utils.{ScorexLogging, _}
...
package object database extends ScorexLogging {
  ...
  implicit class EntryExt(val e: JMap.Entry[Array[Byte], Array[Byte]]) extends AnyVal {
    import com.aeneas.crypto.DigestLength
