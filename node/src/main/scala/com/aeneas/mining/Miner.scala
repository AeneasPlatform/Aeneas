...
import com.aeneas.block.Block._
import com.aeneas.block.{Block, BlockHeader, SignedBlockHeader}
import com.aeneas.consensus.PoSSelector
import com.aeneas.consensus.nxt.NxtLikeConsensusBlockData
import com.aeneas.features.BlockchainFeatures
import com.aeneas.metrics.{BlockStats, Instrumented, _}
import com.aeneas.mining.microblocks.MicroBlockMiner
...
import com.aeneas.transaction.TxValidationError.BlockFromFuture
...
object Miner {
  ...
  val MaxTransactionsPerMicroblock: Int = 600
