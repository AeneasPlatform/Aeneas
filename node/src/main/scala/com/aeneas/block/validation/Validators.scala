package com.aeneas.block.validation

import cats.syntax.either._
import com.aeneas.block.Block.{GenerationSignatureLength, GenerationVRFSignatureLength, MaxFeaturesInBlock, ProtoBlockVersion}
