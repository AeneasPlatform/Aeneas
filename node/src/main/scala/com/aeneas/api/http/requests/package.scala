...
import com.aeneas.crypto.{DigestLength, SignatureLength}
import com.aeneas.lang.ValidationError
import com.aeneas.transaction.Asset.{IssuedAsset, Waves}
import com.aeneas.transaction.TxValidationError.{GenericError, Validation}
import com.aeneas.transaction.{Asset, AssetIdStringLength, Proofs, TxValidationError, TxVersion}
...
package object requests {
  ...
  implicit val byteStrFormat: Format[ByteStr] = com.aeneas.utils.byteStrFormat
