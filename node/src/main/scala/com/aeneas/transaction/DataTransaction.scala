...
import com.aeneas.transaction.validation.impl.DataTxValidator
...
case class DataTransaction(
  ...
  private[aeneas] lazy val protoDataPayload = PBTransactions.protobuf(this).getTransaction.getDataTransaction.toByteArray
}
