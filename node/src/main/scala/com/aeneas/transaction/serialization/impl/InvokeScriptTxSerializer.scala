...
import com.aeneas.lang.v1.compiler.Terms.{EXPR, FUNCTION_CALL}
...
object InvokeScriptTxSerializer {
  def functionCallToJson(fc: Terms.FUNCTION_CALL): JsObject = {
    Json.obj(
      "function" -> JsString(fc.function.asInstanceOf[com.aeneas.lang.v1.FunctionHeader.User].internalName),
      "args" -> JsArray(
        fc.args.map {
