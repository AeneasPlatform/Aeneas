package com.aeneas.transaction.assets.exchange
...
import com.aeneas.transaction.assets.exchange.Validation.booleanOperators
import com.aeneas.transaction.serialization.impl.OrderSerializer
...
object Order {
  ...
  implicit lazy val jsonFormat: Format[Order] = com.aeneas.transaction.assets.exchange.OrderJson.orderFormat
