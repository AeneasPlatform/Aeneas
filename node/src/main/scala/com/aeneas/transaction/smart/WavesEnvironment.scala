...
import com.aeneas.lang.v1.traits.domain.Recipient._
...
class WavesEnvironment(
  ...
  import com.aeneas.lang.v1.traits.Environment._
  ...
  override def resolveAlias(name: String): Either[String, Recipient.Address] =
    blockchain
      .resolveAlias(com.aeneas.account.Alias.create(name).explicitGet())
  ...
  override def accountBalanceOf(addressOrAlias: Recipient, maybeAssetId: Option[Array[Byte]]): Either[String, Long] = {
    (for {
      aoa <- addressOrAlias match {
        ...
        case Alias(name)    => com.aeneas.account.Alias.create(name)
      }
