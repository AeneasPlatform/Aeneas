...
import com.aeneas.lang.v1.traits.domain.Tx.{Header, Proven}
...
import com.aeneas.transaction.assets.exchange.OrderType.{BUY, SELL}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
            ...
            transfers = ms.transfers.map(r => com.aeneas.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
