...
import com.aeneas.settings.UtxSettings
...
import com.aeneas.state.{Blockchain, Diff, Portfolio}
import com.aeneas.transaction.Asset.IssuedAsset
import com.aeneas.transaction.TxValidationError.{AlreadyInTheState, GenericError, SenderIsBlacklisted}
...
import com.aeneas.utils.{LoggerFacade, Schedulers, ScorexLogging, Time}
...
class UtxPoolImpl(
  ...
  import com.aeneas.utx.UtxPoolImpl._
