...
import com.aeneas.mining.Miner.MaxTransactionsPerMicroblock
import com.aeneas.mining.MiningConstraints
import com.aeneas.network.message.Message._
import com.aeneas.network.message._
import com.aeneas.protobuf.block.{PBBlock, PBBlocks, PBMicroBlocks}
...
import com.wavesplatform.protobuf.block.SignedMicroBlock
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://aeneas.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
