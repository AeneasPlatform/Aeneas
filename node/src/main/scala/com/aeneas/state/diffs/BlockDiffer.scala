...
object BlockDiffer extends ScorexLogging {
  ...
  def fromBlockTraced(
    ...
    println(s"stateHeight:$stateHeight, ngHeight:$ngHeight, sponsorshipHeight:$sponsorshipHeight")
  ...
  private[this] def apply(
    ...
    println(s"point 0.1, ${blockchain.height}")
