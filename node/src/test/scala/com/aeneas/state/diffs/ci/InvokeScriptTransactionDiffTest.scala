package com.aeneas.state.diffs.ci

import cats.kernel.Monoid
import com.google.protobuf.ByteString
import com.aeneas.account._
import com.aeneas.block.{Block, BlockHeader, SignedBlockHeader}
import com.aeneas.common.state.ByteStr
import com.aeneas.common.utils.EitherExt2
import com.aeneas.db.{DBCacheSettings, WithState}
...
import com.aeneas.lang.contract.DApp.{CallableAnnotation, CallableFunction}
...
import com.aeneas.lang.v1.FunctionHeader.{Native, User}
...
import com.aeneas.lang.v1.evaluator.FunctionIds.{CREATE_LIST, THROW}
import com.aeneas.lang.v1.evaluator.ctx.impl.waves.{FieldNames, WavesContext}
import com.aeneas.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
import com.aeneas.lang.v1.evaluator.{FunctionIds, ScriptResultV3}
import com.aeneas.lang.v1.parser.{Expressions, Parser}
...
import com.aeneas.state.diffs.invoke.{InvokeDiffsCommon, InvokeScriptTransactionDiff}
import com.aeneas.state.diffs.{ENOUGH_AMT, FeeValidation, produce}
...
import com.aeneas.transaction.smart.script.trace.{AssetVerifierTrace, InvokeScriptTrace}
