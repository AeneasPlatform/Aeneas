...
import com.aeneas.state.utils.addressTransactions
import com.aeneas.transaction.Asset.{IssuedAsset, Waves}
import com.aeneas.transaction.assets.IssueTransaction
import com.aeneas.transaction.{Asset, CreateAliasTransaction, GenesisTransaction, Transaction}
...
class CreateAliasTransactionDiffTest extends PropSpec with PropertyChecks with WithState with TransactionGen with NoShrink {
  ...
  property("can create and resolve aliases preserving ash invariant") {
