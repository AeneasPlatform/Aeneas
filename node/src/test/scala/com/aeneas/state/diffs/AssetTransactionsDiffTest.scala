...
import com.aeneas.features.{BlockchainFeatures, EstimatorProvider}
import com.aeneas.lagonaki.mocks.TestBlock
import com.aeneas.lang.directives.values.{Expression, StdLibVersion, V1, V4}
...
import com.aeneas.{BlocksTransactionsHelpers, NoShrink, TransactionGen}
...
class AssetTransactionsDiffTest
  ...
  property("Issue+Reissue+Burn do not break ash invariant and updates state") {
