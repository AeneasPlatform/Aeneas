...
/**
 * @author luger. Created on 1/16/21.
 * @version ${VERSION}
 */
...
//import com.aeneas.lang.v1.testing.{ScriptGen, TypedScriptGen}
import com.aeneas.lang.v1.{ContractLimits, FunctionHeader}
import com.aeneas.settings.{Constants, FunctionalitySettings}
...
import com.aeneas.transaction.transfer.MassTransferTransaction.{MaxTransferCount, ParsedTransfer}
...
trait TransactionGenBase /*extends ScriptGen with TypedScriptGen*/ extends NTPTime { _: Suite =>
  ...
  val scriptGen: Gen[Script]         = null //exprGen.map(e => ExprScript(e).explicitGet())
  val contractScriptGen: Gen[Script] = null //contractGen.map(e => ContractScript(V3, e).explicitGet())
