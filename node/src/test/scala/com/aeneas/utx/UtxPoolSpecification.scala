...
import com.aeneas.block.{Block, SignedBlockHeader}
import com.aeneas.common.state.ByteStr
import com.aeneas.common.utils.EitherExt2
import com.aeneas.consensus.{PoSSelector, TransactionsOrdering}
import com.aeneas.database.{LevelDBWriter, TestStorageFactory, openDB}
import com.aeneas.db.WithDomain
import com.aeneas.events.UtxEvent
import com.aeneas.features.BlockchainFeatures
import com.aeneas.history.Domain.BlockchainUpdaterExt
import com.aeneas.history.randomSig
...
import com.aeneas.lang.v1.compiler.{CompilerContext, ExpressionCompiler}
import com.aeneas.mining._
import com.aeneas.network.{InvalidBlockStorage, PeerDatabase}
import com.aeneas.settings._
import com.aeneas.state._
import com.aeneas.state.appender.{ExtensionAppender, MicroblockAppender}
import com.aeneas.state.diffs._
import com.aeneas.state.utils.TestLevelDB
import com.aeneas.transaction.Asset.Waves
import com.aeneas.transaction.TxValidationError.{GenericError, SenderIsBlacklisted}
...
import com.aeneas.transaction.{Asset, Transaction, _}
...
class UtxPoolSpecification
  ...
  "UTX Pool" - {
    ...
    "correctly process constraints in packUnconfirmed" in {
      withDomain(aeneas.history.TransfersV2ActivatedAt0WavesSettings) { d =>
    ...
    "priority pool" - {
      ...
      val settingsWithNG = aeneas.history.settingsWithFeatures(BlockchainFeatures.NG, BlockchainFeatures.SmartAccounts)
