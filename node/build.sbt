...
inConfig(Compile)(
  Seq(
    ...
    includeFilter in PB.generate := new SimpleFileFilter((f: File) => f.getName.endsWith(".proto") && (f.getParent.endsWith("waves") ||f.getParent.endsWith("aeneas")) ),
...
inTask(assembly)(
  Seq(
    test := {},
    assemblyJarName := s"aeneas-all-${version.value}.jar",
