...
import com.aeneas.lang.Common._
import com.aeneas.lang.Testing._
import com.aeneas.lang.directives.DirectiveSet
import com.aeneas.lang.directives.values._
import com.aeneas.lang.v1.FunctionHeader.Native
...
import com.aeneas.lang.v1.evaluator.Contextful.NoContext
import com.aeneas.lang.v1.evaluator.EvaluatorV1._
import com.aeneas.lang.v1.evaluator.FunctionIds._
import com.aeneas.lang.v1.evaluator.ctx._
...
import com.aeneas.lang.v1.evaluator.ctx.impl.{CryptoContext, EnvironmentFunctions, PureContext, _}
import com.aeneas.lang.v1.evaluator.{Contextful, ContextfulVal, EvaluatorV1, EvaluatorV2, FunctionIds, Log}
import com.aeneas.lang.v1.testing.ScriptGen
import com.aeneas.lang.v1.traits.Environment
import com.aeneas.lang.v1.{CTX, ContractLimits, FunctionHeader}
...
/*
  ...
  private def recArrWeight(script: String): Either[ExecutionError, EVALUATED] = {
    ...
    com.aeneas.lang.v1.parser.Parser.parseExpr(script) match {
