...
class ScriptResultTest extends PropSpec with PropertyChecks with Matchers with NoShrink {
  ...
  val pureEvalContext : EvaluationContext[Environment, Id] =
    PureContext.build(com.aeneas.lang.Global, V3).withEnvironment[Environment].evaluationContext(utils.environment)
  ...
  val noAsset  = com.aeneas.lang.v1.evaluator.ctx.impl.unit
