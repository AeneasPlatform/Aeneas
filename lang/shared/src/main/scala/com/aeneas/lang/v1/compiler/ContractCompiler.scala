package com.aeneas.lang.v1.compiler

import cats.implicits._
import cats.{Id, Show}
import com.aeneas.lang.contract.DApp
import com.aeneas.lang.contract.DApp._
import com.aeneas.lang.contract.meta.{MetaMapper, V1, V2}
import com.aeneas.lang.directives.values.{StdLibVersion, V3}
import com.aeneas.lang.v1.compiler.CompilationError.{AlreadyDefined, Generic, WrongArgumentType}
import com.aeneas.lang.v1.compiler.CompilerContext.{VariableInfo, vars}
import com.aeneas.lang.v1.compiler.ExpressionCompiler._
import com.aeneas.lang.v1.compiler.Types.{BOOLEAN, BYTESTR, LONG, STRING}
import com.aeneas.lang.v1.evaluator.ctx.FunctionTypeSignature
import com.aeneas.lang.v1.evaluator.ctx.impl._
import com.aeneas.lang.v1.evaluator.ctx.impl.waves.Types._
import com.aeneas.lang.v1.parser.Expressions.Pos.AnyPos
import com.aeneas.lang.v1.parser.Expressions.{FUNC, PART, Type}
import com.aeneas.lang.v1.parser.{Expressions, Parser, ParserV2}
import com.aeneas.lang.v1.task.imports._
