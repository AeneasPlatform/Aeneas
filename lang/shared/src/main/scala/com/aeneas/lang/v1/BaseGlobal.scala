...
import com.aeneas.lang.contract.meta.{FunctionSignatures, MetaMapper, ParsedMeta}
import com.aeneas.lang.contract.{ContractSerDe, DApp}
import com.aeneas.lang.directives.values.{Expression, StdLibVersion, V1, V2, DApp => DAppType}
...
import com.aeneas.lang.utils
import com.aeneas.lang.v1.BaseGlobal.DAppInfo
import com.aeneas.lang.v1.BaseGlobal.ArrayView
...
import com.aeneas.lang.v1.compiler.{CompilationError, CompilerContext, ContractCompiler, ExpressionCompiler}
...
import com.aeneas.lang.v1.evaluator.ctx.impl.crypto.RSA.DigestAlgorithm
import com.aeneas.lang.v1.parser.Expressions
import com.aeneas.lang.v1.parser.Expressions.Pos.AnyPos
import com.aeneas.lang.v1.repl.node.http.response.model.NodeResponse
...
trait BaseGlobal {
  ...
  def parseAndCompileExpression(
    ...
    (for {
      ...
      illegalBlockVersionUsage              = letBlockOnly && com.aeneas.lang.v1.compiler.containsBlockV2(compExpr)
  ...
  def checkExpr(
    ...
    for {
      ...
      illegalBlockVersionUsage = LetBlockVersions.contains(version) &&
        com.aeneas.lang.v1.compiler.containsBlockV2(expr)
      _ <- Either.cond(
