...
import com.aeneas.lang.directives.values.{StdLibVersion, DApp => DAppType}
...
import com.aeneas.lang.v1.{BaseGlobal, FunctionHeader}
  ...
  case class ContractScriptImpl(stdLibVersion: StdLibVersion, expr: DApp) extends Script {
    ...
    override val containsArray: Boolean = {
      ...
      (verifierExpr ::: declExprs ::: callableExprs)
        .exists(com.aeneas.lang.v1.compiler.containsArray)
    }
  }
